...
export async function listTables(id: string, limit?: number, offset?: number, search?: string): Promise<string[]> {
  return await invoke("list_tables", { id, limit, offset, search });
}
